...
class Gestion{
  ...
  async insert_gestion(numero, msg, estado) {
    let comprobar = false;
    let kind='INBOUND';
    const sql = `INSERT INTO ${DB}.tbl_gestion (GES_NUMERO_COMUNICA, GES_CULT_MSGBOT,GES_CDETADICIONAL, GES_CESTADO) VALUES ('${numero}', '${msg}', '${kind}','${estado}')`;
    await connDB
      .promise()
      .query(sql)
      .then(() => {
...
module.exports = { Gestion, Mensaje};
